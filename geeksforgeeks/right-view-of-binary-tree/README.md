...
<pre><span style="font-size: 18px;"><strong>Input: </strong>root = [3] &nbsp; &nbsp;<br> &nbsp;<img src="https://media.geeksforgeeks.org/img-practice/prod/addEditProblem/700153/Web/Other/blobid0_1777967002.png" height="100">
