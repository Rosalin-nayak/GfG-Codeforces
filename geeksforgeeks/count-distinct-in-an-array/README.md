<h2><a href="https://www.geeksforgeeks.org/problems/find-distinct-elements--130928/1">Count Distinct in an Array</a></h2><h3>Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an integer array<strong> arr[]</strong><strong>,</strong> return the count of all the distinct elements in an array</span></p>
