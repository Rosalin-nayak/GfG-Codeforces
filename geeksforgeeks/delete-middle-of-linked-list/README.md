<h2><a href="https://www.geeksforgeeks.org/problems/delete-middle-of-linked-list/1">Delete Middle of Linked List</a></h2><h3>Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">Given a singly linked list, delete the middle<strong>&nbsp;</strong>of the linked list.</span></p>
<p><span style="font-size: 14pt;">Note:</span></p>
<ul>
<li><span style="font-size: 14pt;">If there are even nodes, then there would be two middle nodes, we need to delete the second<strong> </strong>middle element. </span></li>
